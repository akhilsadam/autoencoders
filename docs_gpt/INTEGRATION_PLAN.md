...
install-qg:
	...
	cd lib/qg && $(UV) pip install -e . --python $(PYTHON)

install-mura:
	@echo "Installing Mura package..."
	cd lib/mura && $(UV) pip install -e . --python $(PYTHON)
...
dependencies = [
    ...
    "qg @ file:///${PROJECT_ROOT}/lib/qg",
    "mura @ file:///${PROJECT_ROOT}/lib/mura",
]
...
git submodule add ../qg lib/qg
git submodule add ../mura lib/mura
