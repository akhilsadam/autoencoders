...
autoencoders → fashion_mnist, aesthetic4k, qg_turbulence
             ↓
             qg (lib/qg) - generates physics datasets
             mura (lib/mura) - utilities (optional)
```
...
- `lib/qg/README.md` - QG package documentation
- `lib/mura/README.md` - Mura package documentation
