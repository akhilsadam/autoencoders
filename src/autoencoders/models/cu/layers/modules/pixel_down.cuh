...
struct PixelDNModule : public module<_IN, Transform, Opt> {
    ...
    static constexpr int32_t k_in = 4; // template this
    static constexpr int32_t k_out = 4; // half of k_in
    static constexpr int32_t l_in = IN::C * k_in * k_in;
    static constexpr int32_t l_out = OUT::C * k_out * k_out;
    static constexpr int32_t n_in = IN::N_WT / l_in;
    static constexpr int32_t n_out = OUT::N_WT / l_out;
