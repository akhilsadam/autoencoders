...
// template<class V> __device__ __forceinline__ V operator OP(const V&a,const decltype(a.x)&s){return vop(a,s,FN{});} \
// template<class V> __device__ __forceinline__ V operator OP(const decltype(a.x)&s,const V&a){return rvop(s,a,FN{});}
